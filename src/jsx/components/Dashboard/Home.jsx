...
//Images
import pattern6 from './../../../assets/images/pattern/pattern6.png';
								...
								<div className="col-xl-6">
									<div className="card-bx bg-blue">
										...
										<Link to={"#"} className="change-btn" id="change-btn" >
											<i className="fa fa-caret-up up-ico" />Change
											<span className="reload-icon"><i className="fa fa-refresh reload active" />	</span>
										</Link>
									</div>
								</div>
								<div className="col-xl-6">
					...
					<div className="card">
						<div className="card-header pb-0 border-0">
							...
							<ul className="card-list">
								...
								<li className="justify-content-end">Outcome<span className="oranger-bg circle me-0 ms-2"></span></li>
							</ul>
						</div>
				...
				<div className="col-xl-6 col-xxl-7">
					<div className="card">
						<div className="card-header d-flex flex-wrap border-0 pb-0">
							...
							<Link to={"#"} className="btn btn-rounded btn-md btn-primary mr-3 me-3"><i className="las la-download scale5 me-3" /> Download Report</Link>
							<DropdownBlog />
						</div>
						<div className="card-body pb-2">
							<div className="d-sm-flex d-block">
								...
								<ul className="card-list d-flex mt-sm-0 mt-3">
									...
									<li><span className="oranger-bg circle"></span>Outcome</li>
								</ul>
							</div>
